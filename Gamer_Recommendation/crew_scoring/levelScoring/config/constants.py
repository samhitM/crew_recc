...
ENGAGEMENT_WEIGHT = 0.2  # Weight for consistent engagement
CONTRIBUTION_WEIGHT = 0.2  # Weight for community contributions
VERIFICATION_WEIGHT = 0.1  # Weight for verified status
EVENT_PARTICIPATION_WEIGHT = 0.3  # Weight for event participation
REWARDS_WEIGHT = 0.2  # Weight for rewards
...
DEFAULT_VALUES = {
    ...
    'Rewards': 0.0,  # Default rewards score
    ...
    'Profile_Likes':0.0 # Default for Profile Likes
}
